...
vcf2_output_base="${BASE_DIR}/result/WGS-SVs/Truvari/SURVIVOR/vcf2"  # New base path for vcf2
...
mkdir -p "$input_paths"
mkdir -p "$vcf2_output_base"  # Create vcf2 base directory
...
process_bamfile() {
    ...
    # Create vcf2 output directories (by combination type and sample)
    mkdir -p "${vcf2_output_base}/2to1/${bamfile}" "${vcf2_output_base}/3to2/${bamfile}" \
             "${vcf2_output_base}/4to2/${bamfile}" "${vcf2_output_base}/5to3/${bamfile}"
    ...
    # Process merged VCF: extract DUP, INV, BND separately
    process_merged_vcf() {
        local fixed_vcf="$1"
        ...
        # Filter each SV type
        for svtype in DUP INV BND; do
            filtered_vcf="${output_prefix}_${svtype}.vcf.gz"
            bcftools view -i "SVTYPE=\"${svtype}\"" "$fixed_vcf" -O z -o "$filtered_vcf"
            tabix "$filtered_vcf"
        done
    }
    ...
    for ((i=0; i<total_softwares-1; i++)); do
        for ((j=i+1; j<total_softwares; j++)); do
            combo1="${softwares[i]}"
            combo2="${softwares[j]}"
            output_file="${sample_dir}/${combo_type}/${bamfile}.${combo1}_${combo2}.list"
            merged_vcf="${sample_dir}/${combo_type}/${bamfile}.${combo1}_${combo2}_merged.vcf"
            sorted_vcf="${sample_dir}/${combo_type}/${bamfile}.${combo1}_${combo2}_merged_sorted.vcf"
            fixed_vcf="${sample_dir}/${combo_type}/${bamfile}.${combo1}_${combo2}_merged_sorted_fixed.vcf.gz"
            output_prefix="${vcf2_output_base}/${combo_type}/${bamfile}/${bamfile}_${combo1}_${combo2}_merged"
            ...
            if [[ $(wc -l < "$output_file") -ge 2 ]]; then
                ...
                # Process merged VCF: output DUP, INV, BND separately
                process_merged_vcf "$fixed_vcf" "$output_prefix" "${vcf2_output_base}/${combo_type}/${bamfile}"
    ...
    for ((i=0; i<total_softwares-2; i++)); do
        for ((j=i+1; j<total_softwares-1; j++)); do
            for ((k=j+1; k<total_softwares; k++)); do
                ...
                combo2="${softwares[j]}"
                combo3="${softwares[k]}"
                output_file="${sample_dir}/${combo_type}/${bamfile}.${combo1}_${combo2}_${combo3}.list"
                merged_vcf="${sample_dir}/${combo_type}/${bamfile}.${combo1}_${combo2}_${combo3}_merged.vcf"
                sorted_vcf="${sample_dir}/${combo_type}/${bamfile}.${combo1}_${combo2}_${combo3}_merged_sorted.vcf"
                fixed_vcf="${sample_dir}/${combo_type}/${bamfile}.${combo1}_${combo2}_${combo3}_merged_sorted_fixed.vcf.gz"
                output_prefix="${vcf2_output_base}/${combo_type}/${bamfile}/${bamfile}_${combo1}_${combo2}_${combo3}_merged"
        ...
        for ((j=i+1; j<total_softwares-2; j++)); do
            for ((k=j+1; k<total_softwares-1; k++)); do
                for ((l=k+1; l<total_softwares; l++)); do
                    ...
                    combo3="${softwares[k]}"
                    combo4="${softwares[l]}"
                    output_file="${sample_dir}/${combo_type}/${bamfile}.${combo1}_${combo2}_${combo3}_${combo4}.list"
                    merged_vcf="${sample_dir}/${combo_type}/${bamfile}.${combo1}_${combo2}_${combo3}_${combo4}_merged.vcf"
                    sorted_vcf="${sample_dir}/${combo_type}/${bamfile}.${combo1}_${combo2}_${combo3}_${combo4}_merged_sorted.vcf"
                    fixed_vcf="${sample_dir}/${combo_type}/${bamfile}.${combo1}_${combo2}_${combo3}_${combo4}_merged_sorted_fixed.vcf.gz"
                    output_prefix="${vcf2_output_base}/${combo_type}/${bamfile}/${bamfile}_${combo1}_${combo2}_${combo3}_${combo4}_merged"
            ...
            for ((k=j+1; k<total_softwares-2; k++)); do
                for ((l=k+1; l<total_softwares-1; l++)); do
                    for ((m=l+1; m<total_softwares; m++)); do
                        ...
                        combo4="${softwares[l]}"
                        combo5="${softwares[m]}"
                        output_file="${sample_dir}/${combo_type}/${bamfile}.${combo1}_${combo2}_${combo3}_${combo4}_${combo5}.list"
                        merged_vcf="${sample_dir}/${combo_type}/${bamfile}.${combo1}_${combo2}_${combo3}_${combo4}_${combo5}_merged.vcf"
                        sorted_vcf="${sample_dir}/${combo_type}/${bamfile}.${combo1}_${combo2}_${combo3}_${combo4}_${combo5}_merged_sorted.vcf"
                        fixed_vcf="${sample_dir}/${combo_type}/${bamfile}.${combo1}_${combo2}_${combo3}_${combo4}_${combo5}_merged_sorted_fixed.vcf.gz"
                        output_prefix="${vcf2_output_base}/${combo_type}/${bamfile}/${bamfile}_${combo1}_${combo2}_${combo3}_${combo4}_${combo5}_merged"
