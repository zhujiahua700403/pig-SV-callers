...
def convertInversions(samtools, refFasta, vcfFile, invMateDict):
    ...
    for line in fpVcf:
        ...
        if vcfRec.isINV3 or vcfRec.isINV5:
            if vcfRec.isINV5:
                print("Before adjustment: pos={}, matePos={}".format(vcfRec.pos, vcfRec.matePos))
                vcfRec.pos = max(1, vcfRec.pos - 1)
                vcfRec.matePos = max(1, vcfRec.matePos - 1)
                print("After adjustment: pos={}, matePos={}".format(vcfRec.pos, vcfRec.matePos))
